...
if is_service_enabled calico; then
	...
	stack)
		...
		install)
		    ...
		    git_clone ${CALICO_REPO:-https://github.com/Metaswitch/calico.git} $CALICO_DIR ${CALICO_BRANCH:-routed}
		    cd $CALICO_DIR
		    pip_install -I .

		    # Install python-etcd from our GitHub.
		    pip_install -I git+git://github.com/Metaswitch/python-etcd.git@nj-relax-urllib3-cap
...
EOF
		    ...
		    iniset $Q_DHCP_CONF_FILE DEFAULT interface_driver neutron.agent.linux.interface.RoutedInterfaceDriver
